...
import co.com.sofkau.sura.demobibliotecareactiva.usecases.put.DevolverRecursoUseCase;
...
public class DevolverRecursoRouter {
    @Bean
    public RouterFunction<ServerResponse> devolverRecurso(DevolverRecursoUseCase useCase) {
